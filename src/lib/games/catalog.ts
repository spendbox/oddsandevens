...
export const GAMES: Record<GameType, GameDefinition> = {
  ...
  "advent-calendar": {
    ...
    blurb:
      "A returning-visit machine: doors unlock on their day, and every day you come back is worth more than the last. Works for Christmas, Ramadan, an anniversary week, or a 12-day launch.",
    category: "community",
    engine: "score",
    icon: "calendar-days",
