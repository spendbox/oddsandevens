...
--
-- Creates one contributor account, the free public box, and one staked
...
-- The public box: funded by the platform, so no stake and no split.
insert into public.boxes (
  id, kind, slug, title, blurb, secret, length, guesses_allowed,
  stake_kobo, prize_kobo, platform_fee_kobo, status, published_at
) values (
  '33333333-3333-3333-3333-333333333333',
  'general', 'the-opening-night', 'The Opening Night',
  'Four characters. On us. Have a go.',
  'OPEN', 4, 10,
  0, 5000000, 0, 'live', now()
)
on conflict (id) do nothing;

-- A staked box: ₦1,000,000 in, ₦700,000 prize, ₦300,000 to the platform.
insert into public.boxes (
  id, kind, contributor_id, slug, title, blurb, secret, length, guesses_allowed,
  stake_kobo, prize_kobo, platform_fee_kobo, status, published_at
) values (
  '44444444-4444-4444-4444-444444444444',
  'contributor', '22222222-2222-2222-2222-222222222222',
  'adas-safe', 'Ada''s Safe',
  'Six characters, and one of them is not a letter.',
  'NAIRA!', 6, 12,
